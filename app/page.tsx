...
export default function Home() {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-6 px-5 py-10 sm:px-8 lg:px-10">
      <section className="overflow-hidden rounded-4xl border border-black/10 bg-white shadow-[0_25px_80px_rgba(0,0,0,0.08)]">
        <div className="grid gap-8 p-8 lg:grid-cols-[1.2fr_0.8fr] lg:p-12">
          <div className="space-y-6">
            ...
            <h1 className="max-w-4xl text-4xl font-semibold leading-[0.95] tracking-tighter text-accent sm:text-5xl lg:text-6xl">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                href="/login"
                className="rounded-full border border-black/10 px-6 py-3 text-sm font-semibold text-accent transition hover:bg-black/4"
              >
                Login
              </a>
            </div>
          ...
          <div className="rounded-3xl border border-black/10 bg-panel-strong p-6">
      ...
      <section className="grid gap-6 md:grid-cols-3">
        {backendStatus.map((item, index) => (
          <article
            key={item}
            className="rounded-3xl border border-black/10 bg-white p-6 shadow-[0_18px_50px_rgba(0,0,0,0.05)]"
          >
